onload = () => {
  ...
  audio.volume = 0.1;  // Volume antara 0.0 (diam) dan 1.0 (penuh)
   ...
   // Ambil elemen flower dan love-emote
   const flower = document.querySelector('.flower');
   const loveEmote = flower.querySelector('.love-emote');

   // Ketika flower di-click, tampilkan love emote
   flower.addEventListener('click', () => {
     loveEmote.style.display = 'block';
     setTimeout(() => {
       loveEmote.style.display = 'none';
     }, 1000); // Menyembunyikan setelah 1 detik
   });